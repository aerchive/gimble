<#
  ...
  Keith Mitchell keith@undyne.com; https://github.com/aerchive; http://twitter.com/aerchive
    ...
    but a one-line attribute is requested in all relevant files, for example:
        sourced from https://github.com/aerchive/gimble
        modified from: https://github.com/aerchive/gimble by Keith Mitchell keith@undyne.com

    Quick-Start Guide: Run gimble_scriptlogger.ps1 -usage
    Documentation: See the Quick-Start usage, then read comments in this file!
